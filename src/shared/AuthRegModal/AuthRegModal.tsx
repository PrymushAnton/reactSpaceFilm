...
export function AuthModal(){
    ...
    return(
        <div>
            ...
            <Modal show={showLog} onHide={handleCloseLog} id="AuthModal">
                ...
                <form>
                    ...
                    <Modal.Footer id="AuthRegBottom">
                        ...
                        <button type="button" id="SignButt"  onClick={handleShowReg} >Sign Up</button>
                    </Modal.Footer>
                </form>
            </Modal>

            <Modal show={showReg} onHide={handleCloseReg} id="RegModal">
                ...
                <form>
                    ...
                    <ModalFooter id="AuthRegBottom">
                        ...
                        <button type="button" id="SignButt" onClick={handleShowLog}>Sign In</button>
                    </ModalFooter>
                </form>
            </Modal>
        </div>
